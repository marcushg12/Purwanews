...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php">
    <div class="container">
      ...
      <input type="password" placeholder="Retype Password" id="psw2" onblur="login()" required>
...
public function login() {
  if (pass1=="") {
    ...
    alert('Mohon ketik ulang password anda');
  } 
  if (pass1==pass2) {
    alert('Selamat anda berhasil login');
  } else {
    alert('Password Anda Salah, Mohon Ulang kembali');
  }
}
